...
AI 데이터매니지먼트 과정 조별과제 · 조원 김재관 · 박유선
...
| 공매 분석 보고서 | https://onbid-screener.vercel.app/dash/report | 온비드 13년 (셸 안) 공개통계 |
...
webapp/                 Next.js 15 · React 19 · TypeScript
  app/                  / → /dash/case · /dash/* 시장·사건·목록·보고서 전부 셸 안 · /report → /dash/report
